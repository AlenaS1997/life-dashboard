...
| `health-reminders-workflow.json` | Каждый день 09:00 МСК | Напоминания по здоровью (взвеситься, сдать анализы и т.д.). Sheets-driven — можно добавлять reminder'ы прямо в таблицу. См. отдельный гайд `health-reminders-README.md`. |
